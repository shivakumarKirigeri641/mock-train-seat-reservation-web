        ...
        <div className="flex flex-col md:flex-row flex-1 max-w-7xl mx-auto w-full relative z-10">
            ...
            <div className="p-4 space-y-6">
              ...
              <nav className="space-y-1 pb-20 md:pb-0">
                {apiData?.map((cat, idx) => {
                  ...
                  if (searchQuery && filteredEndpoints?.length === 0)
                    return null;
          ...
          <main className="flex-1 w-full min-w-0 p-4 md:p-8 lg:p-12 overflow-hidden relative z-10">
            <div className="max-w-4xl mx-auto space-y-10">
              {/* Disclaimer */}
              <div className="p-4 bg-orange-900/20 border border-orange-500/20 rounded-xl flex gap-3 items-start animate-slideUp">
              ...
              <div
                className="p-6 bg-gradient-to-br from-indigo-900/30 to-indigo-900/10 border border-indigo-500/30 rounded-2xl space-y-4 animate-slideUp"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  ...
                  <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                    ...
                    <p className="text-xs text-gray-400 mb-2">
                      Your unique API key for authentication. This key
                      identifies your account and is required for all API
                      requests.
                    </p>
                ...
                >
                  ...
                  <div className="mt-10 pt-8 border-t border-gray-800">
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                      ...
                      the endpoint in Postman to see the actual & live
                      responses.
                    </p>
                    ...
                    <div className="bg-orange-500/5 border border-orange-500/20 rounded-xl p-4 mb-6 flex flex-col sm:flex-row items-center gap-4">
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        ...
                        <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                          ...
                          credentials, please test this endpoint using the
                          Postman App.
                        </p>
                      </div>
                      <a
