      ...
      <div className="max-w-4xl mx-auto bg-gray-800 border border-gray-700 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              All sales of API credits, subscription plans, and wallet recharges
              on ServerPe.in are <strong>final and non-refundable</strong>.
            </p>
            <p className="mt-2">
              Once a payment is successfully processed and credits are added to
              your account, we strictly do not offer any refunds, cancellations,
              or chargebacks under any circumstances.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              If a transaction fails but the amount has been deducted from your
              bank account, the amount is usually auto-refunded by the payment
              gateway within 5-7 business days. We do not control this process.
              If credits were <strong>not</strong> added to your wallet for a
              successful deduction, please contact support with your transaction
              ID for manual credit adjustment.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              By making a purchase on ServerPe.in, you acknowledge that you have
              read, understood, and agreed to this No Refund Policy.
            </p>
          </section>
        </div>
