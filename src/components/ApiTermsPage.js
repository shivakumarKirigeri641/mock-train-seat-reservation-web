          ...
          <div className="space-y-6 text-gray-300 leading-relaxed">
            <section>
              ...
              <p>
                ...
                <strong>
                  educational, training, and testing purposes only
                </strong>
                . You agree not to use these endpoints for any commercial
                production environment or real-world transactions.
              </p>
            </section>
